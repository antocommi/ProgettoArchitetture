...
assegnaSoluzioneD:
		...
		pushaq	                                        ; salva i registri generali
          ...
          ciclo:vmovapd ymm0, [rsi+r9*8]
                ...
                vxorpd ymm0, ymm0
                vmovapd [rsi+r9*8], ymm0
                vmovapd [rsi+r9*8+32], ymm0
                vmovapd [rsi+r9*8+64], ymm0
                vmovapd [rsi+r9*8+96], ymm0
                vmovapd [rsi+r9*8+128], ymm0
                vmovapd [rsi+r9*8+160], ymm0
                vmovapd [rsi+r9*8+192], ymm0
                vmovapd [rsi+r9*8+224], ymm0
                vmovapd [rsi+r9*8+256], ymm0
                vmovapd [rsi+r9*8+288], ymm0
                vmovapd [rsi+r9*8+320], ymm0
                vmovapd [rsi+r9*8+352], ymm0
                vmovapd [rsi+r9*8+384], ymm0
                vmovapd [rsi+r9*8+416], ymm0
                vmovapd [rsi+r9*8+448], ymm0
                vmovapd [rsi+r9*8+480], ymm0
                add r9, 64
                cmp r9, rdx
                jl ciclo
