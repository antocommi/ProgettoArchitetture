...
assegnaSoluzioneF:
		...
		pushaq	                                        ; salva i registri generali
          ...
          ciclo:vmovaps ymm0, [rsi+r9*4]
                ...
                vxorps ymm0, ymm0
                vmovaps [rsi+r9*4], ymm0
                vmovaps [rsi+r9*4+32], ymm0
                vmovaps [rsi+r9*4+64], ymm0
                vmovaps [rsi+r9*4+96], ymm0
                vmovaps [rsi+r9*4+128], ymm0
                vmovaps [rsi+r9*4+160], ymm0
                vmovaps [rsi+r9*4+192], ymm0
                vmovaps [rsi+r9*4+224], ymm0
                vmovaps [rsi+r9*4+256], ymm0
                vmovaps [rsi+r9*4+288], ymm0
                vmovaps [rsi+r9*4+320], ymm0
                vmovaps [rsi+r9*4+352], ymm0
                vmovaps [rsi+r9*4+384], ymm0
                vmovaps [rsi+r9*4+416], ymm0
                vmovaps [rsi+r9*4+448], ymm0
                vmovaps [rsi+r9*4+480], ymm0
                add r9, 128
                cmp r9, rdx
                jl ciclo
